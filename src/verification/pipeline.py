...
class VerificationPipeline:
    ...
    def __init__(self, parser: Optional[SolutionParser] = None,
        ...
        Args:
            ...
            arithmetic: Re-executes explicit calculations and compares to claimed results.
            symbolic: Verifies algebraic identities and inequalities using SymPy.
            brute_force: Exhaustive enumeration for claims over finite domains.
            counterexample: Active search to disprove claimed results.
            answer_validator: Checks answer format, range [0,99999], and cross-solution consistency.
